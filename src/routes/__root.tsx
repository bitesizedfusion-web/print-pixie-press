...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "S&S Printing and Packaging — Smart, AI-Powered Printing" },
      { name: "description", content: "AI-assisted online printing — voice search, instant quotes, live previews. Flyers, posters, brochures & more, delivered Australia-wide." },
      { property: "og:title", content: "S&S Printing and Packaging — Smart, AI-Powered Printing" },
      { property: "og:description", content: "AI-assisted online printing — voice search, instant quotes, live previews. Flyers, posters, brochures & more, delivered Australia-wide." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "S&S Printing and Packaging — Smart, AI-Powered Printing" },
      { name: "twitter:description", content: "AI-assisted online printing — voice search, instant quotes, live previews. Flyers, posters, brochures & more, delivered Australia-wide." },
