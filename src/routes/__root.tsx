...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "PrintMaster Australia — Smart, AI-Powered Printing" },
      ...
      { property: "og:title", content: "PrintMaster Australia — Smart, AI-Powered Printing" },
      ...
      { name: "twitter:title", content: "PrintMaster Australia — Smart, AI-Powered Printing" },
