...
export const Route = createFileRoute("/designer")({
  ...
  head: () => ({
    meta: [
      { title: "Free Online Print Designer — Create Flyers, Posters & Cards | S&S Printers" },
      {
        name: "description",
        content:
          "Design your own flyers, posters, business cards and banners in your browser. Drag-and-drop editor, free templates, instant PDF export, fast Australia-wide printing.",
      },
    ],
  }),
...
function DesignerPage() {
  ...
  const [elements, setElements] = useState<DesignElement[]>(() =>
    templateFor("poster-a3", 720 * (297 / 420), 720),
  );
      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-12 gap-4 p-4">
        ...
        <main className="col-span-12 lg:col-span-7">
          ...
          <p className="text-xs text-muted-foreground mt-2 font-mono text-center">
            {format.label} · {format.widthMm}×{format.heightMm}mm · Click an item to edit · Delete
            to remove · ⌘Z to undo
          </p>
        </main>
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateEl({ ...selected, fontSize: Number(e.target.value) || 12 })
                          }
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Button
                        ...
                        size="icon"
                        onClick={() => updateEl({ ...selected, align: "left" })}
                      >
                      ...
                      <Button
                        ...
                        size="icon"
                        onClick={() => updateEl({ ...selected, align: "center" })}
                      >
                      ...
                      <Button
                        ...
                        size="icon"
                        onClick={() => updateEl({ ...selected, align: "right" })}
                      >
                    ...
                    <div>
                      ...
                      <Swatches
                        value={selected.fill}
                        onChange={(c) => updateEl({ ...selected, fill: c })}
                      />
                    </div>
                  </>
                )}
                  ...
                  <>
                    <div>
                      ...
                      <Swatches
                        ...
                        onChange={(c) => updateEl({ ...selected, stroke: c })}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateEl({ ...selected, strokeWidth: Number(e.target.value) || 1 })
                        }
                        className="mt-1 h-8 text-xs"
                      />
                    </div>
                ...
                <button
                  ...
                  className={`w-full text-left text-xs px-2 py-1.5 rounded-md border ${
                    selectedId === el.id
                      ...
                      : "border-border bg-background hover:border-cta/40"
                  }`}
                >
                  {el.type === "text"
                    ? `T · ${(el as { text: string }).text.slice(0, 22)}`
                    : el.type === "image"
                      ? "🖼 Image"
                      : `${el.type[0].toUpperCase()} · ${el.type}`}
                </button>
              ))}
