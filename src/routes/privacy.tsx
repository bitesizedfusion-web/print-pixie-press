          ...
          <div className="prose prose-neutral max-w-none space-y-12 text-muted-foreground leading-relaxed">
            <section className="space-y-4">
              <p className="text-lg text-foreground">
                At S&S Printers, we respect your privacy and protect your personal information.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                Any images, artwork, logos or design files you upload are used only for your
                quotation or order request.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                We do not sell your personal information. We only share details when required to
                complete your order, arrange delivery, or comply with legal requirements.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                We may contact you by email, phone or WhatsApp regarding your enquiry, quote or
                order.
              </p>
            </section>
