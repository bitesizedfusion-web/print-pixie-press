  ...
  head: () => ({
    meta: [
      { title: "How It Works — PrintHub Australia" },
      {
        name: "description",
        content:
          "6 simple steps from browsing to delivery. Upload artwork, pay online, and receive your prints.",
      },
...
const steps = [
  {
    icon: "🌐",
    title: "Visit & Browse",
    desc: "Explore our range of professional print products online",
  },
  {
    icon: "⚙️",
    title: "Configure Order",
    desc: "Select size, quantity, paper type and turnaround",
  },
  ...
  { icon: "🖨️", title: "We Print", desc: "Your order is printed in 1–3 business days" },
  {
    icon: "📦",
    title: "Delivered",
    desc: "Shipped to your door with tracking link sent via email",
  },
];
...
const faqs = [
  {
    ...
    a: "Standard orders take 3–5 business days. Express orders are ready in 1–2 business days.",
  },
  {
    q: "What file formats do you accept?",
    a: "We accept PDF (preferred), AI, PSD, JPG, and PNG files. Minimum 300 DPI resolution.",
  },
  {
    q: "Do you check my file before printing?",
    a: "Yes, our team performs a basic print-ready check on every order at no extra charge.",
  },
  {
    q: "Can I get a proof before printing?",
    a: "Yes! Digital proofs are available on request. Just mention it in your order notes.",
  },
  {
    q: "Do you ship Australia-wide?",
    a: "Absolutely. We deliver to all states and territories across Australia.",
  },
];
    ...
    <div>
      <section className="bg-hero-bg text-hero-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-hero-foreground/70 text-lg">
            From upload to delivery in 6 simple steps
          </p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((s, i) => (
              <motion.div
                ...
                className="bg-card rounded-xl border border-border p-6 text-center hover:shadow-md transition-all"
              >
                <div className="w-14 h-14 mx-auto bg-cta/10 rounded-full flex items-center justify-center text-2xl mb-4">
                  {s.icon}
                </div>
      ...
      <section className="py-16 bg-card text-center">
        <Link to="/order/$product" params={{ product: "flyers" }}>
