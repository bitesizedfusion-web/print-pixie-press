...
export const products: Product[] = [
  { id: 'flyers', name: 'Flyers & Leaflets', description: 'A4, A5, DL — Perfect for promotions and events', sizes: ['A4', 'A5', 'DL'], startingPrice: 45, icon: '📄', image: productFlyers, category: 'Flyers' },
  { id: 'posters', name: 'Posters', description: 'A3 to A0 — Eye-catching wall displays', sizes: ['A3', 'A2', 'A1', 'A0'], startingPrice: 45, icon: '🖼️', image: productPosters, category: 'Posters' },
  { id: 'brochures', name: 'Brochures', description: 'Tri-fold, Bi-fold — Professional marketing materials', sizes: ['Tri-fold', 'Bi-fold'], startingPrice: 149, icon: '📖', image: productBrochures, category: 'Brochures' },
  { id: 'banners', name: 'Pull-up Banners', description: '850×2000mm — Stand-out at events and expos', sizes: ['850×2000mm'], startingPrice: 99, icon: '🏗️', image: productBanners, category: 'Banners' },
  { id: 'calendars', name: 'Calendars', description: 'Wall & Desk — Branded calendars year-round', sizes: ['Wall', 'Desk'], startingPrice: 75, icon: '📅', image: productCalendars, category: 'Calendars' },
  { id: 'certificates', name: 'Certificates', description: 'Award & Custom — Professional recognition', sizes: ['A4', 'A3'], startingPrice: 65, icon: '🏆', image: productCertificates, category: 'Certificates' },
];
...
export function getPricingTable(productId: string): { size: string; prices: Record<number, number> }[] {
  const productPrices = basePrices[productId];
